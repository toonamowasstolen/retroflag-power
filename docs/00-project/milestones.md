...
audience:
  ...
  - AI Assistants
  - Future Maintainers
purpose: Define the milestone path for RetroFlag Power so the project can move from dream, to daemon, to resume platform, to public release without losing momentum or scope control.
related:
  - WHY.md
  - PROJECT_MEMORY.md
