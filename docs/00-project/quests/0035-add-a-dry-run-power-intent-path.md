...
> Light the first [power](../../../internal/power) lantern, but keep it on the workbench: bright enough to
...
- The [planner](../../../internal/planner) can turn the power intent into a deterministic dry-run plan.
- The planned action remains `noop`.
- The [app](../../../internal/app) can process the power intent through the existing planner and
  [executor](../../../internal/executor) path.
